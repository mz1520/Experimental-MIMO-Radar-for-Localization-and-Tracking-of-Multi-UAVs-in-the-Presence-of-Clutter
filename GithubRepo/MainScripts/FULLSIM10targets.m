...
Range5 = 58.6887543; %range of the target in meters
delay6 = 456;%Delay in samples (i.e. clock time)
pad_zeros6 = 16227-delay6-15360;
RCS5 = 1;% RCS of the target, assumed 1
theta6 = deg2rad(27);
k_6 = 2*pi*(Fc/c_light)*[cos(theta6)*cos(0), sin(theta6)*cos(0), sin(0)].';
...
B6 = 1;
Target_6_response = B6*(S_Tx_6*S_Tx_6')*Full_Tx_signal;
Target_7_delayed = [zeros(5,delay6),Target_6_response,zeros(5,pad_zeros6)]; 

%Target 9

Range5 = 58.6887543; %range of the target in meters
delay6 = 649;%Delay in samples (i.e. clock time)
pad_zeros6 = 16227-delay6-15360;
RCS5 = 1;% RCS of the target, assumed 1
theta6 = deg2rad(167);
k_6 = 2*pi*(Fc/c_light)*[cos(theta6)*cos(0), sin(theta6)*cos(0), sin(0)].';
...
B6 = 1;
Target_6_response = B6*(S_Tx_6*S_Tx_6')*Full_Tx_signal;
Target_9_delayed = [zeros(5,delay6),Target_6_response,zeros(5,pad_zeros6)]; 

%Target 10

Range5 = 58.6887543; %range of the target in meters
delay6 = 333;%Delay in samples (i.e. clock time)
pad_zeros6 = 16227-delay6-15360;
RCS5 = 1;% RCS of the target, assumed 1
theta6 = deg2rad(38);
k_6 = 2*pi*(Fc/c_light)*[cos(theta6)*cos(0), sin(theta6)*cos(0), sin(0)].';
...
B6 = 1;
Target_6_response = B6*(S_Tx_6*S_Tx_6')*Full_Tx_signal;
Target_10_delayed = [zeros(5,delay6),Target_6_response,zeros(5,pad_zeros6)]; 
...
% Aggregate all target responses
Received_signal_nonoise = Target_1_delayed_d + Target_2_delayed + Target_4_delayed +Target_3_delayed + Target_1_delayed + Target_5_delayed + Target_6_delayed+...
    Target_7_delayed+ Target_9_delayed+ Target_10_delayed;
...
disp(K)
K=10; % 19 works for 2 targets   %For alternate threedcube(the shorter one) 2 works for 2 on imag resluts
...
% Interpolate the magnitude and phase of Z values over the grid
